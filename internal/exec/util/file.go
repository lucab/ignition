...
// CopyFile copies the content of `src` to `dst`, truncating if already existing.
...
// CopyDir recursively copies a directory tree, creating the destination directory.
